...
type (
	...
	SettingsResponse struct {
		...
		ConsoleTcpMaxRetransmissions ConsoleTcpMaxRetransmissions `xml:"ConsoleTcpMaxRetransmissions,omitempty"` // Indicates the number of retransmissions host TCP SW tries ifno ack is accepted
...
type SettingsRequest struct {
	...
	MACAddress                   string                       `xml:"h:MACAddress,omitempty"`                   // The MAC address used by Intel® AMT in a string format. For Example: 01-02-3f-b0-99-99. (This property can only be read and can't be changed.)
