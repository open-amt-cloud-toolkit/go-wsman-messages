...
type (
	...
	GeneralSettingsResponse struct {
		...
		ThunderboltDockEnabled        ThunderboltDockEnabled `xml:"ThunderboltDockEnabled,omitempty"`        // When set to Disabled, a management console cannot communicate with Intel AMT via a Thunderbolt dock. Available in Release 15.0 and later releases.
...
type (
	GeneralSettingsRequest struct {
		...
		DigestRealm                   string                 `xml:"h:DigestRealm,omitempty"`                   // The Intel® AMT device Digest Authentication Realm parameter as defined by RFC 2617. This is a read-only property.
		...
		PrivacyLevel                  PrivacyLevel           `xml:"h:PrivacyLevel,omitempty"`                  // Defines the Privacy and Security Level setting. This is a read-only property.
		PowerSource                   PowerSource            `xml:"h:PowerSource,omitempty"`                   // The system current power source. This is a read-only property.
		ThunderboltDockEnabled        ThunderboltDockEnabled `xml:"h:ThunderboltDockEnabled,omitempty"`        // When set to Disabled, a management console cannot communicate with Intel AMT via a Thunderbolt dock. Available in Release 15.0 and later releases.
...
// The system current power source.  This is a read-only property.
//
// ValueMap={0, 1, 2..}
//
